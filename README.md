...
<p align="center">
  <img src="./assets/cover.jpg" alt="혼자 공부하는 C 언어 표지" width="300"/>
</p>

이 저장소는 **서현우 저 / 한빛미디어 – “혼자 공부하는 C 언어”** 책의 예제를 직접 따라 작성하며 정리한 공간입니다.  
각 챕터별 코드 실습과 학습 내용을 체계적으로 기록하는 것을 목표로 합니다.
...
| 폴더 | 설명 |
|------|-------|
| [Chapter01](https://github.com/eunchaeee/studyC/tree/main/Chapter01) | 프로그램 만들기 |
